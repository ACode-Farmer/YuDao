...
@implementation DynamicCell
{
    ...
    OperationMenuView *_operationMenu;
}
...
- (void)setup
{
    ...
    _operationMenu = [OperationMenuView new];
...
- (void)setModel:(DynamicCellModel *)model
{
    _model = model;
    ...
    _picContainerView.picPathStringsArray = model.picNameArray;
