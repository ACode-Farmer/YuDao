...
- (void)viewDidLoad {
    ...
    self.tableView.rowHeight = 50*widthHeight_ratio;
    [self.tableView registerClass:[YDLikedListCell class] forCellReuseIdentifier:likedListCellID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    YDLikedListCell *cell = [tableView dequeueReusableCellWithIdentifier:likedListCellID];
    return cell;
}
