...
#import "YDEmojiDisplayView.h"

#define     SIZE_TIPS    CGSizeMake(55, 100)

@interface YDEmojiDisplayView ()
...
@implementation YDEmojiDisplayView
...
- (void)setEmoji:(YDEmoji *)emoji
{
    ...
    else if (emoji.type == YDEmojiTypeFace) {
...
//    }];
    ...
    .widthRatioToView(self.imageView,1)
    .heightRatioToView(self.imageView,1)
